...
public class SecurityUtil {
    ...
    public static List<Long> getCurrentUserDataScope(){
        UserDetails userDetails = getCurrentUser();
        JSONObject dataScopeJsonObject =(JSONObject) ((JSONObject) JSONObject.toJSON(userDetails)).get("dataScopes");
        return JSONObject.parseArray(dataScopeJsonObject.toJSONString()).toJavaList(Long.class);
    }
