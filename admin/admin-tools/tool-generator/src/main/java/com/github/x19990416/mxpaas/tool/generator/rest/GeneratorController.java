...
public class GeneratorController {
    ...
    public ResponseEntity<Object> queryColumns(@RequestParam String tableName){
        ...
        return new ResponseEntity<>(com.github.x19990416.mxpaas.admin.common.utils.PageUtil.toPage(columnInfos,columnInfos.size()), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Object> generator(@PathVariable String tableName, @PathVariable Integer type, HttpServletRequest request, HttpServletResponse response) throws Exception {
