...
import com.github.x19990416.mxpaas.admin.common.utils.DateUtil;
import com.github.x19990416.mxpaas.admin.common.utils.FileUtil;
import com.github.x19990416.mxpaas.admin.common.utils.StringUtil;
...
public class MonitorServiceImpl implements MonitorService {
  ...
  public Map<String, Object> getServers() {
    ...
    try {
      ...
      resultMap.put("time", new SimpleDateFormat("HH:mm:ss").format(new Date()));
    } catch (Exception e) {
      e.printStackTrace();
    }
    return resultMap;
  ...
  private Map<String, Object> getDiskInfo(OperatingSystem os) {
    ...
    for (OSFileStore fs : fsArray) {
      ...
      if (osName.toLowerCase().startsWith(SysAdminConstant.WIN)) {
  ...
  private Map<String, Object> getSystemInfo(OperatingSystem os) {
    ...
    // 计算项目运行时间
    String formatBetween = DateUtil.formatTimeBetween(time, System.currentTimeMillis());
    // 系统信息
